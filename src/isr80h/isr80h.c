...
void isr80h_register_commands()
{
    ...
    isr80h_register_command(SYSTEM_COMMAND10_GETMOUSEX, isr80h_command10_getmouseX);
    isr80h_register_command(SYSTEM_COMMAND11_GETMOUSEY, isr80h_command10_getmouseY);
}
